...
type CB={onTimeUpdate?:(t:number,d:number)=>void;onStateChange?:(s:PlayerState)=>void;onTrackEnd?:()=>void;onError?:(e:string)=>void;onLoad?:(d:number)=>void;onVolumeChange?:(v:number)=>void}
